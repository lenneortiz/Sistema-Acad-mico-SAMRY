...
case 7:
            ?>
              <h4 class="h4">Disculpe el nombre de usuario ya se encuentra asignado a un usuario</h4>
            <?php
      break;
  ...
  ?>
      ...
      <div id="login">
        ...
        <form id="formBuscador" name="busqueda" method="POST" action="../control/editCuentaUserControl.php">
...
<input type="text" name="login" class="inputText" id="textfield" />
  ...
  <input type="password" name="pass" class="inputText" id="textfield2" />
        ...
        <a class="black_button" href="javascript:void(0);"onclick="document.busqueda.submit();"onclick="return val_form_this_page();"><span>Actualizar</span></a>
